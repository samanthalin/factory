...
$(document).ready(function() {
    ...
    function getMotorHistory(dateTime) {
        var url = 'http://140.124.184.204:8080/Cloud/Iotivity/QuerySecond?second=' + dateTime
    ...
    function getWsnHistory(date, mote) {
        var url = 'http://140.124.184.204:8080/Cloud/WSN/queryDate?epoch='+date+'&mote='+mote
        console.log(url)
        $.getJSON(url, function(data) {
            // Create the chart
            var reData = data.map(value => {
